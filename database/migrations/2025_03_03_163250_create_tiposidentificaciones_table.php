...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('tiposidentificaciones', function (Blueprint $table) {
            ...
            $table->string('nombre', 150)->comment('El dato nombre del Tipo Identificacion');
            $table->string('descripcion')->comment('El dato descripcion del Tipo Identificacion');
    ...
    {
        Schema::dropIfExists('tiposidentificaciones');
    }
};