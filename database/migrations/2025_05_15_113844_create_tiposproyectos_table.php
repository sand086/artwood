...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('tiposproyectos', function (Blueprint $table) {
            $table->id('tipo_proyecto_id');
            $table->string('nombre')->comment('El dato nombre del Tipo de Proyecto');
            $table->string('descripcion', 1024)->nullable()->comment('El dato descripcion del Tipo de Proyecto');
