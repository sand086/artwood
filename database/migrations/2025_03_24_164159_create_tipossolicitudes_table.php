...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('tipossolicitudes', function (Blueprint $table) {
            $table->id('tipo_solicitud_id');
            $table->string('nombre')->comment('El dato nombre del Tipo de Solicitude');
            $table->string('descripcion')->nullable()->comment('El dato descripcion del Tipo de Solicitude');
