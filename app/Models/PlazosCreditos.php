...
class PlazosCreditos extends Model
{
    use HasFactory;
     ...
     * @var string
     */
    protected $table = 'plazoscreditos';
     ...
     * @var string
     */
    protected $primaryKey = 'plazo_credito_id'; // Clave primaria personalizada
     ...
     */
    protected $guarded = [
      'plazo_credito_id', 'estado', 'fecha_registro', 'fecha_actualizacion'
    ];
