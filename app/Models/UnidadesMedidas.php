...
class UnidadesMedidas extends Model
{
     ...
     * @var string
     */
    protected $primaryKey = 'unidad_medida_id'; // Clave primaria personalizada
     ...
     */
    protected $fillable = [
        'nombre', 'categoria', 'simbolo', 'estado'
    ];
     ...
     */
    protected $guarded = [
      'unidad_medida_id', 'estado', 'fecha_registro', 'fecha_actualizacion'
    ];
