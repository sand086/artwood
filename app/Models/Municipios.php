...
class Municipios extends Model
{
     ...
     * @var string
     */
    protected $primaryKey = 'municipio_id'; // Clave primaria personalizada
     ...
     */
    protected $fillable = [
        'nombre', 'codigo_postal', 'estado_pais_id', 'estado'
    ];
     ...
     */
    protected $guarded = [
      'municipio_id', 'estado', 'fecha_registro', 'fecha_actualizacion'
    ];
