...
class Servicios extends Model
{
     ...
     * @var string
     */
    protected $primaryKey = 'servicio_id'; // Clave primaria personalizada
     ...
     */
    protected $fillable = [
        'nombre', 'descripcion', 'tiempo', 'unidad_medida_id', 'precio', 'estado'
    ];
     ...
     */
    protected $guarded = [
      'servicio_id', 'estado', 'fecha_registro', 'fecha_actualizacion'
    ];
