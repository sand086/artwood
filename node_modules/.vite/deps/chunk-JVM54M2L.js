import {
  dataTables_default
} from "./chunk-LPY4IGMI.js";
import {
  require_jquery
} from "./chunk-RRM5ZGGZ.js";
import {
  __toESM
...
$.extend(Buttons.prototype, {
  ...
  */
  ...
  disable: function(node) {
    var button = this._nodeToButton(node);
    if (button.isSplit) {
      $(button.node.childNodes[0]).addClass(this.c.dom.button.disabled).prop("disabled", true);
    } else {
  ...
  enable: function(node, flag) {
    ...
    var button = this._nodeToButton(node);
    if (button.isSplit) {
      $(button.node.childNodes[0]).removeClass(this.c.dom.button.disabled).prop("disabled", false);
    } else {
  ...
  */
  ...
  _expandButton: function(attachTo, button, split, inCollection, inSplit, attachPoint, parentConf) {
    ...
    for (var i = 0, ien = buttons.length; i < ien; i++) {
      ...
      if (built.conf.dropIcon && !built.conf.split) {
        $(built.node).addClass(this.c.dom.button.dropClass).append(this.c.dom.button.dropHtml);
      }
    ...
    for (var i = 0; i < buttons.length; i++) {
      ...
      if (button.isSplit) {
        ...
        if (this._checkAnyEnabled(button.buttons)) {
          $(splitBtn).removeClass(this.c.dom.button.disabled).prop("disabled", false);
        } else {
          $(splitBtn).addClass(this.c.dom.button.disabled).prop("disabled", false);
        }
  ...
  _popover: function(content, hostButton, inOpts) {
    ...
    if (options.sort) {
      var elements = $("button", content).map(function(idx, el) {
        return {
          text: $(el).text(),
          el
        };
    ...
    setTimeout(function() {
      ...
      $("body").on("click.dtb-collection", function(e) {
        ...
        var elements2 = $("a, button", content);
...
var dataTables_buttons_default = dataTables_default;
...
datatables.net-buttons/js/dataTables.buttons.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-JVM54M2L.js.map
