...
$.extend(dataTables_default.ext.buttons, {
  ...
  columnVisibility: {
    ...
    _columnText: function(dt, conf) {
      ...
      title = dataTables_default.Buttons.stripHtmlComments(title);
      title = dataTables_default.util.stripHtml(title).trim();
...
var buttons_colVis_default = dataTables_default;
export {
...
datatables.net-buttons/js/buttons.colVis.mjs:
   ...
   *)
*/
//# sourceMappingURL=datatables__net-buttons_js_buttons__colVis.js.map
