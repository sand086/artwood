...
<aside x-data="combinedAccess()"
    ...
    <div class="flex items-center justify-between h-16 px-4 border-b border-gray-200">
        <img src="{{ asset('images/icons/artwood-logo.svg') }}" alt="Logo" width="110" x-show="sidebarOpen" />
            ...
            <li x-data="{ open: window.location.pathname.startsWith('/dashboard') }">
                <button @click="open = !open"
                    ...
                    <div class="flex items-center gap-3">
                        <img src="{{ asset('images/icons/sidebar/iconos_dashboard.svg') }}" alt="Dashboards" width="25"
                            class="flex-shrink-0" />
                        <span x-show="sidebarOpen" x-transition.opacity>Dashboards</span>
                    </div>
                    <img src="{{ asset('images/icons/sidebar/iconos_chevron-down.svg') }}" alt="Toggle" width="16"
                ...
                <ul x-show="open" x-transition class="ml-4 mt-1 space-y-1">
                    ...
                    <!-- Cotizaciones -->
                    <li>
                        <a href="{{ route('dashboard.cotizaciones') }}"
                            ...
                            <img src="{{ asset('images/icons/sidebar/iconos_cotizacion.svg') }}" alt="Cotizaciones"
                    ...
                    <!-- Proyectos -->
                    <li>
                        <a href="{{ route('dashboard.proyectos') }}"
                            class="flex items-center gap-3 p-2 rounded-md text-gray-700 hover:bg-gray-100"
                            :class="{ 'sidebar-active': window.location.pathname === '/dashboard/proyectos' }">
                            <img src="{{ asset('images/icons/sidebar/iconos_proyectos.svg') }}" alt="Proyectos"
                                width="25" class="flex-shrink-0" />
                    ...
                    <!-- Configuración -->
                    <li>
                        <a href="{{ route('dashboard.administracion') }}"
                            class="flex items-center gap-3 p-2 rounded-md text-gray-700 hover:bg-gray-100"
                            :class="{ 'sidebar-active': window.location.pathname === '/dashboard/administracion' }">
                            <img src="{{ asset('images/icons/sidebar/iconos_configuraciones.svg') }}"
                    ...
                    <ul x-show="open" x-transition class="ml-4 mt-1 space-y-1">
                        ...
                        <li>
                            <a href="{{ route('areas.index') }}"
                                ...
                                <img src="{{ asset('images/icons/sidebar/iconos_areas.svg') }}" alt="Áreas" width="25"
                                    class="flex-shrink-0" />
                        ...
                        <li>
                            <a href="{{ route('estadosgenerales.index') }}"
                                class="flex items-center gap-3 p-2 rounded-md text-gray-700 hover:bg-gray-100"
                                :class="{ 'sidebar-active': window.location.pathname.startsWith('/estadosgenerales') }">
                                <img src="{{ asset('images/icons/sidebar/iconos_categorias.svg') }}"
                        ...
                        <li>
                            <a href="{{ route('fuentes.index') }}"
                                ...
                                <img src="{{ asset('images/icons/sidebar/iconos_fuentes.svg') }}" alt="Fuentes"
                                    width="25" class="flex-shrink-0" />
                        ...
                        <li>
                            <a href="{{ route('personas.index') }}"
                                ...
                                <img src="{{ asset('images/icons/sidebar/iconos_personas.svg') }}" alt="Personas"
                                    width="25" class="flex-shrink-0" />
                        ...
                        <li>
                            <a href="{{ route('plazoscreditos.index') }}"
                                class="flex items-center gap-3 p-2 rounded-md text-gray-700 hover:bg-gray-100"
                                :class="{ 'sidebar-active': window.location.pathname.startsWith('/plazoscreditos') }">
                                <img src="{{ asset('images/icons/sidebar/iconos_plazosdecreditos.svg') }}"
                        ...
                        <li>
                            <a href="{{ route('procesos.index') }}"
                                ...
                                <img src="{{ asset('images/icons/sidebar/iconos_procesos.svg') }}" alt="Procesos"
                                    width="25" class="flex-shrink-0" />
                        ...
                        <li>
                            <a href="{{ route('tiposclientes.index') }}"
                                class="flex items-center gap-3 p-2 rounded-md text-gray-700 hover:bg-gray-100"
                                :class="{ 'sidebar-active': window.location.pathname.startsWith('/tiposclientes') }">
                                <img src="{{ asset('images/icons/sidebar/iconos_tipodeclientes.svg') }}"
                        ...
                        <li>
                            <a href="{{ route('tiposgastos.index') }}"
                                class="flex items-center gap-3 p-2 rounded-md text-gray-700 hover:bg-gray-100"
                                :class="{ 'sidebar-active': window.location.pathname.startsWith('/tiposgastos') }">
                                <img src="{{ asset('images/icons/sidebar/iconos_tiposdegastos.svg') }}"
                        ...
                        <li>
                            <a href="{{ route('tiposidentificaciones.index') }}"
                                class="flex items-center gap-3 p-2 rounded-md text-gray-700 hover:bg-gray-100"
                                :class="{ 'sidebar-active': window.location.pathname.startsWith('/tiposidentificaciones') }">
                                <img src="{{ asset('images/icons/sidebar/iconos_identificaciones.svg') }}"
                        ...
                        <li>
                            <a href="{{ route('tiposrecursos.index') }}"
                                class="flex items-center gap-3 p-2 rounded-md text-gray-700 hover:bg-gray-100"
                                :class="{ 'sidebar-active': window.location.pathname.startsWith('/tiposrecursos') }">
                                <img src="{{ asset('images/icons/sidebar/iconos_tiposrecursos.svg') }}"
                        ...
                        <li>
                            <a href="{{ route('unidadesmedidas.index') }}"
                                class="flex items-center gap-3 p-2 rounded-md text-gray-700 hover:bg-gray-100"
                                :class="{ 'sidebar-active': window.location.pathname.startsWith('/unidadesmedidas') }">
                                <img src="{{ asset('images/icons/sidebar/iconos_unidaddemedida.svg') }}"
                        ...
                        <li>
                            <a href="{{ route('paises.index') }}"
                                ...
                                <img src="{{ asset('images/icons/sidebar/iconos_paises.svg') }}" alt="Países" width="25"
                                    class="flex-shrink-0" />
                        ...
                        <li>
                            <a href="{{ route('estadospaises.index') }}"
                                class="flex items-center gap-3 p-2 rounded-md text-gray-700 hover:bg-gray-100"
                                :class="{ 'sidebar-active': window.location.pathname.startsWith('/estadospaises') }">
                                <img src="{{ asset('images/icons/sidebar/iconos_estadosPais.svg') }}"
                        ...
                        <li>
                            <a href="{{ route('municipios.index') }}"
                                ...
                                <img src="{{ asset('images/icons/sidebar/iconos_municipios.svg') }}" alt="Municipios"
                                    width="25" class="flex-shrink-0" />
                    ...
                    <ul x-show="open" x-transition class="ml-4 mt-1 space-y-1">
                        ...
                        <li>
                            <a href="{{ route('usuarios.index') }}"
                                ...
                                <img src="{{ asset('images/icons/sidebar/iconos_usuario.svg') }}" alt="Usuarios"
                                    width="25" class="flex-shrink-0" />
                        ...
                        <li>
                            <a href="{{ route('roles.index') }}"
                                ...
                                <img src="{{ asset('images/icons/sidebar/iconos_roles.svg') }}" alt="Roles" width="25"
                                    class="flex-shrink-0" />
                        ...
                        <li>
                            <a href="{{ route('permisos.index') }}"
                                ...
                                <img src="{{ asset('images/icons/sidebar/iconos_permisos.svg') }}" alt="Permisos"
                                    width="25" class="flex-shrink-0" />
            ...
            window.location.pathname.startsWith('/cotizacionesanalisis')
                    ...
                    <button @click="open = !open"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <img src="{{ asset('images/icons/sidebar/Iconos_administrador_de_archivos.svg') }}"
                    ...
                    <ul x-show="open" x-transition class="ml-4 mt-1 space-y-1">
                        ...
                        <li>
                            <a href="{{ route('clientes.index') }}"
                                ...
                                <img src="{{ asset('images/icons/sidebar/iconos_clientes.svg') }}" alt="Clientes"
                                    width="25" class="flex-shrink-0" />
                        ...
                        <li>
                            <a href="{{ route('empleados.index') }}"
                                ...
                                <img src="{{ asset('images/icons/sidebar/iconos_empleados.svg') }}" alt="Empleados"
                                    width="25" class="flex-shrink-0" />
                        ...
                        <li>
                            <a href="{{ route('proveedores.index') }}"
                                ...
                                <img src="{{ asset('images/icons/sidebar/iconos_proveedores.svg') }}" alt="Proveedores"
                                    width="25" class="flex-shrink-0" />
                        ...
                        <li>
                            <a href="{{ route('productos.index') }}"
                                ...
                                <img src="{{ asset('images/icons/sidebar/iconos_productos.svg') }}" alt="Productos"
                                    width="25" class="flex-shrink-0" />
                        ...
                        <li>
                            <a href="{{ route('servicios.index') }}"
                                ...
                                <img src="{{ asset('images/icons/sidebar/iconos_servicios.svg') }}" alt="Servicios"
                                    width="25" class="flex-shrink-0" />
                        ...
                        <li>
                            <a href="{{ route('materiales.index') }}"
                                ...
                                <img src="{{ asset('images/icons/sidebar/Iconos_materiales.svg') }}" alt="Materiales"
                                    width="25" class="flex-shrink-0" />
                        ...
                        <li>
                            <a href="{{ route('equipos.index') }}"
                                ...
                                <img src="{{ asset('images/icons/sidebar/Iconos_equipo.svg') }}" alt="Equipos"
                                    width="25" class="flex-shrink-0" />
                        ...
                        <li>
                            <a href="{{ route('cotizacionessolicitudes.index') }}"
                                class="flex items-center gap-3 p-2 rounded-md text-gray-700 hover:bg-gray-100"
                                :class="{ 'sidebar-active': window.location.pathname.startsWith('/cotizacionessolicitudes') }">
                                <img src="{{ asset('images/icons/sidebar/iconos_solicituddecotizacion.svg') }}"
                        ...
                        <li>
                            <a href="{{ route('cotizacionesanalisis.index') }}"
                                class="flex items-center gap-3 p-2 rounded-md text-gray-700 hover:bg-gray-100"
                                :class="{ 'sidebar-active': window.location.pathname.startsWith('/cotizacionesanalisis') }">
                                <img src="{{ asset('images/icons/sidebar/iconos_analisisdecotizacion.svg') }}"
                        ...
                        <li>
                            <a href="{{ route('cotizaciones.index') }}"
                                class="flex items-center gap-3 p-2 rounded-md text-gray-700 hover:bg-gray-100"
                                :class="{ 'sidebar-active': window.location.pathname.startsWith('/cotizacionesanalisis') }">
                                <img src="{{ asset('images/icons/sidebar/iconos_cotizacion.svg') }}" alt="Análisis"
                                    width="25" class="flex-shrink-0" />
                                <span x-show="sidebarOpen" x-transition:opacity>Cotizaciones</span>
                            </a>
                        </li>
