...
@section('title', 'Proveedores Materiales')

@section('content')
    <div class="@container mx-auto px-4 py-8"  data-module="ProveedoresMateriales"> {{-- Margen y padding con Tailwind --}}
        <h1 class="text-3xl font-semibold mb-6">Proveedores Materiales</h1>
        ...
        <x-modal id="proveedoresmaterialesModal" formId="proveedoresmaterialesForm" :showCancelButton="true" :showSaveButton="true" :showClearButton="true">
            {{-- Seccion HEADER del modal --}}
            <x-slot name="header">
                <h5 class="text-lg font-semibold">Formulario Proveedores Materiales</h5>
            </x-slot>
