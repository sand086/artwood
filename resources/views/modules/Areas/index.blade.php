...
@section('content')
    <div class="@container mx-auto px-4 py-8"  data-module="Areas"> {{-- Margen y padding con Tailwind --}}
        ...
        <x-modal id="areasModal" formId="areasForm" :showCancelButton="true" :showSaveButton="true" :showClearButton="true">
