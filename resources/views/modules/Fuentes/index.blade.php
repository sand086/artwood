...
@section('content')
    <div class="@container mx-auto px-4 py-8"  data-module="Fuentes"> {{-- Margen y padding con Tailwind --}}
        ...
        <x-modal id="fuentesModal" formId="fuentesForm" :showCancelButton="true" :showSaveButton="true" :showClearButton="true">
