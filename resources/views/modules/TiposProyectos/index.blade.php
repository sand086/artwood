...
@section('content')
    <div class="@container mx-auto px-4 py-8"  data-module="TiposProyectos"> {{-- Margen y padding con Tailwind --}}
        <h1 class="text-3xl font-semibold mb-6">Tipos Proyectos</h1>

        <div class="overflow-x-auto"> {{-- Para la tabla responsive --}}
            <table id="tiposproyectosTable" class="min-w-full divide-y divide-gray-200">
        ...
        <x-modal id="tiposproyectosModal" formId="tiposproyectosForm" :showCancelButton="true" :showSaveButton="true" :showClearButton="true">
            {{-- Seccion HEADER del modal --}}
            <x-slot name="header">
                <h5 class="text-lg font-semibold">Formulario Tipos Proyectos</h5>
            </x-slot>
            {{-- Seccion BODY del modal --}}
            <x-slot name="body">
                <form id="tiposproyectosForm" method="POST">
                    @csrf
