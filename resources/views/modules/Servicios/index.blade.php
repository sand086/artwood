...
@section('content')
    <div class="@container m-8 px-4 sm:px-6 lg:px-8" data-module="Servicios">
        ...
        <x-modal id="serviciosModal" formId="serviciosForm" :showCancelButton="true" :showSaveButton="true"
            :showClearButton="true">
            {{-- Seccion HEADER del modal --}}
            <x-slot name="header">
                <h5 class="text-lg font-semibold">Formulario Servicios</h5>
            </x-slot>
            ...
            <x-slot name="body">
                    ...
                    <div class="grid grid-cols-1 gap-1">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-1">
                            ...
                            <div class="col-span-1 p-2 rounded-lg ">
                                ...
                                <input type="number" id="tiempo" name="tiempo" class="art-input-custom text-right" min="1" step="1" required>
                            </div>

                            <div class="col-span-1 p-2 rounded-lg ">
                                <label for="precio" class="art-label-custom">Costo Unitario</label>
                                <div class="flex mt-1">
                                    ...
                                    <input type="number" id="precio" name="precio" class="art-input-custom rounded-l-none text-right" min="0" step="0.01" required>
                                </div>
                            </div>
                        </div>
                ...
                {{-- <x-buttons formId="serviciosForm" /> --}}
            </x-slot>
