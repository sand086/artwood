...
@section('content')
    <div class="@container m-8 px-4 sm:px-6 lg:px-8" data-module="Roles">
        ...
        <x-modal id="rolesModal" formId="rolesForm" :showCancelButton="true" :showSaveButton="true" :showClearButton="true">
            {{-- Sección HEADER del modal --}}
            <x-slot name="header">
                <h5 class="text-lg font-semibold">Formulario Roles</h5>
            </x-slot>
