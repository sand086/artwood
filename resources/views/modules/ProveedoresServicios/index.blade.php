...
@section('title', 'Proveedores Servicios')

@section('content')
    <div class="container mx-auto px-4 py-8"> {{-- Margen y padding con Tailwind --}}
        <h1 class="text-3xl font-semibold mb-6">Proveedores Servicios</h1>
        ...
        <x-modal id="proveedoresserviciosModal" formId="proveedoresserviciosForm" :showCancelButton="true" :showSaveButton="true" :showClearButton="true">
            {{-- Seccion HEADER del modal --}}
            <x-slot name="header">
                <h5 class="text-lg font-semibold">Formulario Proveedores Servicios</h5>
            </x-slot>
