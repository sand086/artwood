...
const configPP = {
    moduleName: 'ProveedoresProductos',
    baseUrl: '/proveedoresproductos/',
    idField: 'proveedor_producto_id',
    formFields: ['proveedor_id', 'producto_id', 'descripcion', 'unidad_medida_id', 'precio_unitario', 'detalle', 'stock', 'estado'],
    moduleForm: 'proveedoresproductosForm',
    moduleTable: 'proveedoresproductosTable',
    moduleModal: 'proveedoresModal', // 'proveedoresproductosModal',
    ...
    targetTab: 'productos', // Nombre de la pestaña a la que se redirige despues de un evento
    formIsInModal: false, // Determina si el formulario está dentro de un modal
    showFormEventName: 'show-form-producto',  // Nombre del evento para mostrar el formulario
    hideFormEventName: 'hide-form-producto',
    columns: [
        // { data: 'proveedor_id', name: 'proveedor_id', title: 'Proveedor', visible: false },
        // { data: 'producto_id', name: 'producto_id', title: 'Producto', visible: false },
        { data: 'producto_nombre', name: 'producto_nombre', title: 'Producto' },
    ...
    onEditSuccess: (data) => {
        ...
        // tab = 'productos';
        window.dispatchEvent(new CustomEvent('show-form-producto'));
    },
};

const proveedoresproductosModule = new BaseModule(configPP);
proveedoresproductosModule.init();
