const configCC = {
    moduleName: 'ClientesContactos',
    baseUrl: '/clientescontactos/',
    idField: 'cliente_contacto_id',
    formFields: ['cliente_id', 'persona_id', 'cargo', 'telefono', 'correo_electronico', 'observaciones'],
    moduleForm: 'clientescontactosForm',
    moduleTable: 'clientescontactosTable',
    moduleModal: 'clientesModal',
    parentIdField: 'cliente_id',  // ID del padre del modulo cuando es una pestaña
...
const clientescontactosModule = new BaseModule(configCC);
clientescontactosModule.init();
