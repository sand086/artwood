...
<?php $__env->startSection('content'); ?>
    <div class="@container mx-auto px-4 py-8" data-module="Equipos"> 
...
<?php $component = App\View\Components\Modal::resolve(['id' => 'equiposModal','formId' => 'equiposForm','showCancelButton' => true,'showSaveButton' => true,'showClearButton' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\FormSelect::resolve(['name' => 'unidad_medida_id','id' => 'unidad_medida_id','label' => 'Unidad Medida','table' => 'unidadesmedidas','valueField' => 'unidad_medida_id','labelField' => 'nombre','where' => ['estado' => 'A'],'orderBy' => ['nombre','asc'],'placeholder' => 'Seleccione una unidad'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'art-select-custom w-full']); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.appP', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\github\artwoort\resources\views/modules/Equipos/index.blade.php ENDPATH**/ ?>