...
<?php $__env->startSection('content'); ?>
    <div class="@container mx-auto px-4 py-8"  data-module="Areas"> 
        <h1 class="text-3xl font-semibold mb-6">Areas</h1>

        <div class="overflow-x-auto"> 
            <table id="areasTable" class="min-w-full divide-y divide-gray-200">
...
<?php $component = App\View\Components\Modal::resolve(['id' => 'areasModal','formId' => 'areasForm','showCancelButton' => true,'showSaveButton' => true,'showClearButton' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
             ...
             <?php $__env->slot('header', null, []); ?> 
                <h5 class="text-lg font-semibold">Formulario Areas</h5>
             <?php $__env->endSlot(); ?>
...
<?php echo $__env->make('layouts.appP', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\github\artwoort\resources\views/modules/Areas/index.blade.php ENDPATH**/ ?>