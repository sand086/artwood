...
<?php $__env->startSection('meta'); ?>
    <meta name="recaptcha-key" content="<?php echo e(env('GOOGLE_RECAPTCHA_KEY')); ?>">
            ...
            <div class="bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
                ...
                <div class="relative rounded-t-xl overflow-hidden flex justify-center mb-6">
                    <img class="size-full top-0 left-0 object-cover group-hover:scale-105 group-focus:scale-80 transition-transform duration-500 ease-in-out rounded-t-xl"
                        src="<?php echo e(asset('images/icons/artwood-logo.svg')); ?>" alt="Logo" width="200">
                </div>
                        ...
                        <div class="mt-1 text-gray-500">
                            <div class="max-w-sm space-y-3">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <a href="<?php echo e(route('recoveryContrasena')); ?>"
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script src="https://www.google.com/recaptcha/api.js?render=<?php echo e(env('GOOGLE_RECAPTCHA_KEY')); ?>" async defer></script>

    
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/modules/Autenticacion/login.js'); ?>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\github\artwoort\resources\views/modules/Autenticacion/login.blade.php ENDPATH**/ ?>