<?php $__env->startSection('title', 'Tipos Identificaciones'); ?>

<?php $__env->startSection('content'); ?>
    <div class="@container mx-auto px-4 py-8"  data-module="TiposIdentificaciones"> 
        <h1 class="text-3xl font-semibold mb-6">Tipos Identificaciones</h1>

        <div class="overflow-x-auto"> 
            <table id="tiposidentificacionesTable" class="min-w-full divide-y divide-gray-200">
...
<?php $component = App\View\Components\Modal::resolve(['id' => 'tiposidentificacionesModal','formId' => 'tiposidentificacionesForm','showCancelButton' => true,'showSaveButton' => true,'showClearButton' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
             ...
             <?php $__env->slot('header', null, []); ?> 
                <h5 class="text-lg font-semibold">Formulario Tipos Identificaciones</h5>
             <?php $__env->endSlot(); ?>
            
             <?php $__env->slot('body', null, []); ?> 
                <form id="tiposidentificacionesForm" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.appP', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\github\artwoort\resources\views/modules/TiposIdentificaciones/index.blade.php ENDPATH**/ ?>