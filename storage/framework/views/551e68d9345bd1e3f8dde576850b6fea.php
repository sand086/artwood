...
<?php $component = App\View\Components\Modal::resolve(['id' => 'empleadosModal','formId' => 'empleadosForm','showCancelButton' => true,'showSaveButton' => true,'showClearButton' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\FormSelect::resolve(['label' => 'Persona','name' => 'persona_id','id' => 'persona_id','table' => 'vw_contactos','valueField' => 'persona_id','labelField' => 'nombre_completo','where' => ['estado' => 'A', 'empleado_id' => 'IS NOT NULL'],'orderBy' => ['nombres', 'asc'],'placeholder' => 'Seleccione una Persona'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                            ...
                            <div class="col-span-1 p-2 rounded-lg ">
                                ...
                                <a href="#" @click.prevent="abrirVentana('<?php echo e(route('personas.create')); ?>', '?openModal=true&windowClose=true')" class="art-btn-secondary ml-2">Crear Persona</a>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.appP', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\github\artwoort\resources\views/modules/Empleados/index.blade.php ENDPATH**/ ?>